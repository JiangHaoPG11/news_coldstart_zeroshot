...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_GAN_NRMS_ATT = self.args.checkpoint_dir + ('checkpoint-Zeroshot_GAN_NRMS_ATT-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_GAN_NRMS_ATT)
    ...
    def test(self):
        ...
        with no_grad():
            ...
            pbar.close()
        # 存储预测结果
        folder_path = '../predict/GAN_NRMS_ATT/'
        ...
        predict_df.to_csv('Zeroshot_GAN_NRMS_ATT_predict.csv', index = False)
