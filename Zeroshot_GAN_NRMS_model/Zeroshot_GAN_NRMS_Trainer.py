...
class Trainer():
    ...
    def optimize_model(self, rec_score, user_gan_loss, label):
        ...
        loss = rec_loss + ( user_gan_loss) * 0.4
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_GAN_NRMS = self.args.checkpoint_dir + ('checkpoint-Zeroshot_GAN_NRMS-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_GAN_NRMS)
    ...
    def test(self):
        ...
        predict_df.to_csv('Zeroshot_GAN_NRMS_predict.csv', index = False)
