...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_NAML_ATT = self.args.checkpoint_dir + ('checkpoint-Zeroshot_NAML_ATT-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_NAML_ATT)
    ...
    def test(self):
        ...
        predict_df.to_csv('Zeroshot_NAML_ATT_predict.csv', index = False)
