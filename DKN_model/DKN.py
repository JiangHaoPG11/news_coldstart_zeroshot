...
class DKN(torch.nn.Module):
    def __init__(self, args, entity_embedding, relation_embedding, news_entity_dict, entity_adj, relation_adj,
        ...
        # DKN
        self.news_encoder = news_encoder(self.args.batch_size, self.args.word_embedding_dim, self.args.entity_embedding_dim,
                                         self.args.news_entity_size, self.args.kcnn_num_filters, self.args.kcnn_window_sizes, False)
        self.user_encoder = user_encoder(self.args.user_clicked_num, self.args.word_embedding_dim, self.args.entity_embedding_dim,
                                         self.args.news_entity_size, self.args.kcnn_num_filters, self.args.kcnn_window_sizes, False)
