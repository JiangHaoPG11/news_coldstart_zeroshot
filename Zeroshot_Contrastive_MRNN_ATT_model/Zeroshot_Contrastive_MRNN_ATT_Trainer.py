...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_Contrastive_MRNN_ATT = self.args.checkpoint_dir + ('checkpoint-Zeroshot_Contrastive_MRNN_ATT-epoch{}.pth'.format(epoch))
    ...
    def test(self):
        ...
        predict_df.to_csv('Zeroshot_Contrastive_MRNN_ATT_predict.csv', index = False)
