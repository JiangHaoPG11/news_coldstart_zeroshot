...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_NAML = self.args.checkpoint_dir + ('checkpoint-Zeroshot_NAML-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_NAML)
    ...
    def test(self):
        ...
        predict_df.to_csv('Zeroshot_NAML_predict.csv', index = False)
