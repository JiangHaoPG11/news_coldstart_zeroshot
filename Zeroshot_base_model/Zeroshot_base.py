...
class Zeroshot_base(torch.nn.Module):
    def __init__(self, args, entity_embedding, relation_embedding, news_entity_dict, entity_adj, relation_adj,
        ...
        super(Zeroshot_base, self).__init__()
        self.args = args
        self.device = device
        ...
        # self.predict_layer = predict_content_layer(args)
        # self.predict_layer = predict_full_layer(args)
