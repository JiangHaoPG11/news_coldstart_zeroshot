...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_Contrastive_NPA_ATT = self.args.checkpoint_dir + ('checkpoint-Zeroshot_Contrastive_NPA_ATT-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_Contrastive_NPA_ATT)
    ...
    def test(self):
        ...
        with no_grad():
            ...
            pbar.close()
        # 存储预测结果
        folder_path = '../predict/Contrastive_NPA_ATT/'
        ...
        predict_df.to_csv('Zeroshot_Contrastive_NPA_ATT_predict.csv', index = False)
