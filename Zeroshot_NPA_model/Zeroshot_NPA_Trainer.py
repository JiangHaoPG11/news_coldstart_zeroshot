...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_NPA = self.args.checkpoint_dir + ('checkpoint-Zeroshot_NPA-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_NPA)
    ...
    def test(self):
        ...
        predict_df.to_csv('Zeroshot_NPA_predict.csv', index = False)
