...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_NPA_ATT = self.args.checkpoint_dir + ('checkpoint-Zeroshot_NPA_ATT-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_NPA_ATT)
    ...
    def test(self):
        ...
        predict_df.to_csv('Zeroshot_NPA_ATT_predict.csv', index = False)
