...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_MRNN_ATT = self.args.checkpoint_dir + ('checkpoint-Zeroshot_MRNN_ATT-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_MRNN_ATT)
    ...
    def test(self):
        ...
        predict_df.to_csv('Zeroshot_MRNN_ATT_predict.csv', index = False)
