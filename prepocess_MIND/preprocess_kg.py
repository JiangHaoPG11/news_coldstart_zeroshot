...
news_entity_index_df = pd.read_csv('../Data_MIND/df/entity_index_df.csv')
news_entity_embedding = np.load('../Data_MIND/metadata/news_entity_embedding.npy')
...
def map_graph_to_index(graph, entity_id_list, relation_id_list):
    ...
    entityid2index.to_csv('../Data_MIND/KG/entityid2index.csv')
    ...
    relationid2index.to_csv('../Data_MIND/KG/relationid2index.csv')
    ...
    graph.to_csv('../Data_MIND/KG/graph_index.csv')
...
def get_transE_embedding(entity_index_list, relation_index_list, graph_index, news_entity_num, news_entity_embedding):
    ...
    np.save("../Data_MIND/KG/TransE_entity_embedding", np.array(entities_embedding))
    np.save("../Data_MIND/KG/TransE_relation_embedding", np.array(relations_embedding))
